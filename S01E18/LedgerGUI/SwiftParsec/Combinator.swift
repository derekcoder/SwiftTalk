...
public extension GenericParser where StreamType.ArrayLiteralElement: Equatable {
    
    public func onlyIf(peek check: @escaping (StreamType.ArrayLiteralElement) -> Bool) -> GenericParser<StreamType, UserState, Result> {
...
public extension Parsec where StreamType.ArrayLiteralElement == Result {
