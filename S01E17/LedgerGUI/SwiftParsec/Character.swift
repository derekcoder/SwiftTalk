...
public extension Parsec where StreamType.ArrayLiteralElement == Character, Result == Character {
...
public extension Parsec where StreamType.ArrayLiteralElement == Character {
    ...
    public static func string<StringStream: Stream>(_ str: StringStream) -> GenericParser<StreamType, UserState, StringStream> where StringStream.ArrayLiteralElement == Character {
