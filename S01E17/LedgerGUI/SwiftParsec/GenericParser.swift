...
public extension Parsec {
    ...
    public static func tokenPrimitive(tokenDescription: @escaping (StreamType.ArrayLiteralElement) -> String, nextPosition: @escaping (SourcePosition, StreamType.ArrayLiteralElement, StreamType) -> SourcePosition, match: @escaping (StreamType.ArrayLiteralElement) -> Result?) -> GenericParser<StreamType, UserState, Result> {
...
public extension Parsec where StreamType.ArrayLiteralElement: Equatable {
    ...
    public static func tokens<OtherStream: Stream>(tokensDescription: @escaping (OtherStream) -> String, nextPosition: @escaping (SourcePosition, OtherStream) -> SourcePosition, tokens: OtherStream) -> GenericParser<StreamType, UserState, OtherStream> where OtherStream.ArrayLiteralElement == StreamType.ArrayLiteralElement {
